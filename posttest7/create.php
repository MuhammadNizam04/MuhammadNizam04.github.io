...
<head>
    ...
    <style>
        ...
        .submit-button {
    background-color: red ; /* Use !important to override other styles */
    color: white;
    border: none;
    padding: 10px 20px;
    border-radius: 5px;
    cursor: pointer;
    font-size: 18px;
    transition: background-color 0.3s ease, transform 0.3s ease; /* Add transform property for scaling */
}
